...
<head>
    ...
    <title> Admin-View Verification List</title>
...
<div>
    <div>
		<div class="bg-primary text-white-50">
			...
			<h1 class="text-center" > Verification List</h1>
		</div>
...
-->
	...
	<div class="text-center">
		<button class="btn btn-primary text-center" type="button" onclick="tableToCSV()">
			download CSV
		</button>
	</div>
</div>
